...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-ep-731-erd-s-problem-731-3f6317ea-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/EP-731"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-ep-731-erd-s-problem-731-3f6317ea-v1",
      "problem_contract_sha256": "b52f7c99a39b0ee874c22073bb0eb542973f723e3d70d655f8517836015cf902",
      "problem_id": "problem:um-ep-731-erd-s-problem-731-3f6317ea",
      "route_id": "route:um-ep-731-erd-s-problem-731-3f6317ea-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-ep-731-erd-s-problem-731-3f6317ea-source-fidelity-01",
      "graph_id": "graph:um-ep-731-erd-s-problem-731-3f6317ea-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-ep-731-erd-s-problem-731-3f6317ea-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-ep-731-erd-s-problem-731-3f6317ea-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Find some reasonable function $f(n)$ such that, for almost all integers $n$, the least integer $m$ such that $m mid \\binom{2n}{n}$ satisfies $ m\\sim f(n). $"
          },
          "statement_sha256": "31985cbee87fd85762e2a85c93df1a4a8b00e261ac91f02d9b3836dad434007c"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-ep-731-erd-s-problem-731-3f6317ea-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-ep-731-erd-s-problem-731-3f6317ea-root",
      "route_id": "route:um-ep-731-erd-s-problem-731-3f6317ea-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-ep-731-24a45a4db47a",
        "url": "https://www.unsolvedmath.com/problems/EP-731"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
